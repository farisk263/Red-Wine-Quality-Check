...
public class PlotUtil {
    ...
    public static void plotLossGraph(String chartTitle, String XLabel, String YLabel, ArrayList<Double> xValuesList1, ArrayList<Double> xValuesList2, int numOfEpochs){

        // call createGraph function to draw the graph
        JFreeChart lineGraph = createGraph(chartTitle, XLabel, YLabel, xValuesList1, xValuesList2, numOfEpochs);
